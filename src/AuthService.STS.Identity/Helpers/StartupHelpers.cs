...
using AuthService.STS.Identity.Configuration;
using AuthService.STS.Identity.Configuration.ApplicationParts;
using AuthService.STS.Identity.Configuration.Constants;
using AuthService.STS.Identity.Configuration.Interfaces;
using AuthService.STS.Identity.Helpers.Localization;
using System.Linq;
